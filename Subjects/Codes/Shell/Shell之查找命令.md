...
======
 ...
 #查阅笔记 #来源/转载 #知识 #发布/个人网站 



日常操作时，经常需要查找文件。在Linux中，有很多方法可以做到这一点。国外网站[LinuxHaxor](http://www.linuxhaxor.net/?p=904)总结了五条命令，你可以看看自己知道几条。
...
## **[locate](https://www.zhihu.com/search?q=locate&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"article"%2C"sourceId"%3A"427486457"})**
...
- k [千字节](https://www.zhihu.com/search?q=千字节&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"article"%2C"sourceId"%3A"427486457"})
- M 兆字节
- G 吉字节
- c 字节
- b 块，一般为512字节
...
-group，-nogroup类似的用法，只不过条件是[用户组](https://www.zhihu.com/search?q=用户组&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"article"%2C"sourceId"%3A"427486457"})。
...
- atime 最后访问时间
- mtime 最后修改时间
- [ctime](https://www.zhihu.com/search?q=ctime&search_source=Entity&hybrid_search_source=Entity&hybrid_search_extra={"sourceType"%3A"article"%2C"sourceId"%3A"427486457"}) 最后修改时间，这里包括属性和权限
