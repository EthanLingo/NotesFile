...
近期收集的LXR-(the linux cross referencer)站点，[点击此处查看维基百科上LXR的释义](https://link.zhihu.com/?target=https%3A//en.wikipedia.org/wiki/LXR_Cross_Referencer)。LXR是linux源代码的一种查看工具。一下这些网站使用LXR为我们索引了多个版本的linux内核源码，方便我们学习和查看
